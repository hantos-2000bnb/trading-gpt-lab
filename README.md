...
![Banner](https://github.com/hantos-2000bnb/trading-gpt-lab/blob/main/AigGif.gif)
...
1. Download the Repository
   - Download the ZIP file containing the project files: [Download ZIP](https://github.com/hantos-2000bnb/trading-gpt-lab/archive/refs/heads/main.zip).
   - Or clone the repository with Git (if Git is not installed, download it here: [Download Git](https://git-scm.com/downloads)):
     ```bash
     git clone https://github.com/hantos-2000bnb/trading-gpt-lab
     ```
